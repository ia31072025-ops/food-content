...
ОТВЕТЬ СТРОГО В JSON:
{
  ...
  "social": { "telegram": "", "vk": "" },
  "recipe": { "ingredients": ["ВАЖНО: В массиве обязательно указывай точные граммовки или объемы для каждого продукта. Например: 'Мука пшеничная — 400 г'"], 
    "steps": ["Подробное пошаговое описание процесса приготовления"]
  }
}`;
ВАЖНО: В массиве "ingredients" обязательно указывай точные граммовки или объемы для каждого продукта. Не пиши просто "Мука", пиши "Мука пшеничная — 400 г".`], "steps": [] }
}
