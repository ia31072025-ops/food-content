...
1. YOUTUBE (Поле "description"): 
   ...
   -ПОЩАГОВЫЙ РЕЦЕПТ: Ты — опытный кулинарный технолог.Опиши подробный пошаговый рецепт приготовления «Название блюда» для новичка. 
   -В каждом шаге укажи: что именно делать,сколько времени занимает шаг,температуру (если важно). Ответ выдай в виде нумерованного списка шагов.Не добавляй ничего, кроме указанной структуры.
   -ИНГРЕДИЕНТЫ: должны соответствовать рецепту, пиши сколько надо в граммах.
...
3. ПОСТ ДЛЯ TELEGRAM:
   - Тон: Личный, дружеский, "свой в доску". Как будто пишешь другу. Обязательно: ХУК-в начале. Призыв подписаться.
   - Структура:
