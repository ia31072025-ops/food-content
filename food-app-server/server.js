...
1. YOUTUBE (Поле "description"): 
   ...
   -ПОЩАГОВЫЙ РЕЦЕПТ: Ты — опытный кулинарный технолог.Опиши подробный пошаговый рецепт приготовления «Название блюда» для новичка.Ты — опытный кулинарный технолог. 
   -В каждом шаге укажи: что именно делать,сколько времени занимает шаг,температуру (если важно). Ответ выдай в виде нумерованного списка шагов.
